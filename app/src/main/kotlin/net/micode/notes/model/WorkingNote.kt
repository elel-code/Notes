...
class WorkingNote {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    if (DataConstants.NOTE == type) {
                        ...
                        mNote.textDataId = cursor.getLong(DATA_ID_COLUMN)
                    } else if (DataConstants.CALL_NOTE == type) {
                        mNote.callDataId = cursor.getLong(DATA_ID_COLUMN)
                    } else {
    ...
    fun saveNote(): Boolean {
        if (this.isWorthSaving) {
             ...
             */
            if (mWidgetId != AppWidgetManager.INVALID_APPWIDGET_ID && mWidgetType != Notes.TYPE_WIDGET_INVALIDE) {
    ...
    companion object {
        ...
        val DATA_PROJECTION: Array<String> = arrayOf(
